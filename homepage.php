...
<body>
  ...
  <div class="w3-sidebar w3-bar-block w3-border-right" style="width: 300px; display:none; background-color: #04AA6D;" id="mySidebar">
    ...
    <hr>
    <a href="profil.php" class="w3-bar-item w3-button" style="background-color: #4abe4d;"><b>Cek Profile</b></a><br>
    <a href="index.php" class="w3-bar-item w3-button" style="background-color: red;"><b>logout</b></a>
  </div>
  ...
  <div style="padding: 20px; text-align: center;">
    ...
    <!-- <button id="cari" style="width: auto; height: auto; display: inline;">Cari</button> -->
    <img style=":hover {background:yellow;}" src="search.webp" style width="30" height="auto">
    <br>
  </div>
